...
const FrostedDotsBackground = ({ className = '', style = {}, speed = 1.5 }) => {
  ...
  // 🔧 全局优化：统一使用性能友好的参数
  const blurRadius = 80; // 从 120px 降到 80px
  ...
  // 🔧 光斑配置 - 全局使用 3 个光斑 + 较小尺寸
  const blobs = useMemo(() => [
    {
      id: 1,
      size: 'clamp(350px, 50vw, 800px)', // 从 1217px 降到 800px
    ...
    {
      id: 2,
      size: 'clamp(300px, 40vw, 600px)', // 从 913px 降到 600px
    ...
    {
      id: 3,
      size: 'clamp(400px, 55vw, 900px)', // 从 1369px 降到 900px
